...
public class ActividadEvaluable_2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ActividadEvaluable_2 frame = new ActividadEvaluable_2();
	...
	public ActividadEvaluable_2() {
		...
		comboBoxTipo.setBounds(279, 277, 179, 21);
		...
		rdbtnCuatro.setBounds(162, 474, 103, 21);
		...
		rdbtnDiez.setBounds(279, 474, 103, 21);
		...
		rdbtnVeintiuno.setBounds(384, 474, 103, 21);
		...
		chckbxNewCheckBox.setBounds(502, 474, 121, 21);
		contentPane.add(chckbxNewCheckBox);
		
		JButton btnNewButton = new JButton("Ver datos tecleados ");
		btnNewButton.setBackground(Color.LIGHT_GRAY);
		btnNewButton.setFont(new Font("Tahoma", Font.PLAIN, 15));
		btnNewButton.setBounds(102, 537, 211, 32);
		...
		btnNewButton_1.setBounds(425, 537, 190, 32);
		contentPane.add(btnNewButton_1);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(174, 619, 556, 121);
